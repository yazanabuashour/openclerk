...
- [v0.2.3](https://github.com/yazanabuashour/openclerk/releases/tag/v0.2.3) adds web source URL intake, richer source update stale-impact responses, read-side tag filters, read-only memory-router recall and evidence-bundle reports, narrow compile-synthesis and source-audit workflow actions, expanded skill policy hardening, and mandatory expanded repo-docs dogfood release evidence.
