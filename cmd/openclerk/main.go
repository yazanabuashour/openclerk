...
func clerkUsage(w io.Writer) {
	_, _ = fmt.Fprintln(w, "usage: openclerk clerk <run> [options]")
	_, _ = fmt.Fprintln(w, "")
	...
	_, _ = fmt.Fprintln(w, "MVP command:")
