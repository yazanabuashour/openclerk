...
func documentUsage(w io.Writer) {
	...
	_, _ = fmt.Fprintln(w, "  Returns final_answer, top-level agent_handoff, and compile_synthesis.agent_handoff with final-answer evidence; use primitives only after rejection or explicit drill-down.")
