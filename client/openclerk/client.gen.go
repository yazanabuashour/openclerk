// Package openclerk provides primitives to interact with the openapi HTTP API.
//
...
type ClientInterface interface {
	...
	// GraphNeighborhoodWithBody request with any body
	GraphNeighborhoodWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	GraphNeighborhood(ctx context.Context, body GraphNeighborhoodJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) GraphNeighborhoodWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGraphNeighborhoodRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GraphNeighborhood(ctx context.Context, body GraphNeighborhoodJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGraphNeighborhoodRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewGraphNeighborhoodRequest calls the generic GraphNeighborhood builder with application/json body
func NewGraphNeighborhoodRequest(server string, body GraphNeighborhoodJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewGraphNeighborhoodRequestWithBody(server, "application/json", bodyReader)
}

// NewGraphNeighborhoodRequestWithBody generates requests for GraphNeighborhood with any type of body
func NewGraphNeighborhoodRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v1/extensions/graph/neighborhood")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// GraphNeighborhoodWithBodyWithResponse request with any body
	GraphNeighborhoodWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*GraphNeighborhoodResp, error)

	GraphNeighborhoodWithResponse(ctx context.Context, body GraphNeighborhoodJSONRequestBody, reqEditors ...RequestEditorFn) (*GraphNeighborhoodResp, error)
...
type GraphNeighborhoodResp struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *GraphNeighborhoodResponse
	JSONDefault  *ErrorResponse
}

// Status returns HTTPResponse.Status
func (r GraphNeighborhoodResp) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GraphNeighborhoodResp) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// GraphNeighborhoodWithBodyWithResponse request with arbitrary body returning *GraphNeighborhoodResp
func (c *ClientWithResponses) GraphNeighborhoodWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*GraphNeighborhoodResp, error) {
	rsp, err := c.GraphNeighborhoodWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGraphNeighborhoodResp(rsp)
}

func (c *ClientWithResponses) GraphNeighborhoodWithResponse(ctx context.Context, body GraphNeighborhoodJSONRequestBody, reqEditors ...RequestEditorFn) (*GraphNeighborhoodResp, error) {
	rsp, err := c.GraphNeighborhood(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGraphNeighborhoodResp(rsp)
...
// ParseGraphNeighborhoodResp parses an HTTP response from a GraphNeighborhoodWithResponse call
func ParseGraphNeighborhoodResp(rsp *http.Response) (*GraphNeighborhoodResp, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GraphNeighborhoodResp{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest GraphNeighborhoodResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
