...
```bash
OPENCLERK_VERSION=v0.2.0 sh -c "$(curl -fsSL https://github.com/yazanabuashour/openclerk/releases/download/v0.2.0/install.sh)"
```
...
mise exec -- ./scripts/validate-release-docs.sh v0.2.0
```
