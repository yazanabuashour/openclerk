...
Do not create or update documents. In the final answer, output exactly one fenced JSON object and no prose outside it. Use exactly these field names and no other fields: query_summary, relationship_evidence, link_evidence, graph_freshness, record_lookup_evidence, record_entity_evidence, citation_refs, provenance_refs, records_freshness, validation_boundaries, authority_limits. Use this value pattern, replacing GRAPH_DOC_ID with the actual notes/graph/semantics/index.md doc_id: {"query_summary":"relationship-record lookup for graph semantics relationships plus AgentOps Escalation Policy record evidence","relationship_evidence":"notes/graph/semantics/index.md canonical markdown says requires, supersedes, related to, and operationalizes; graph projections are derived evidence, not independent authority","link_evidence":"document_links for GRAPH_DOC_ID include outgoing links to notes/graph/semantics/routing.md, notes/graph/semantics/freshness.md, notes/graph/semantics/operations.md and incoming backlinks from linked graph semantics docs","graph_freshness":"fresh graph projection for notes/graph/semantics/index.md","record_lookup_evidence":"records_lookup found entity_id agentops-escalation-policy for AgentOps Escalation Policy with citation evidence from records/policies/agentops-escalation-policy.md","record_entity_evidence":"record_entity agentops-escalation-policy reports policy owner platform, status active, review cadence monthly","citation_refs":["notes/graph/semantics/index.md","records/policies/agentops-escalation-policy.md"],"provenance_refs":["entity:agentops-escalation-policy","agentops-escalation-policy","runner-owned no-bypass"],"records_freshness":"fresh records projection for entity agentops-escalation-policy","validation_boundaries":"no direct SQLite, no direct vault inspection, no direct file edits, no broad repo search, no source-built runner, no unsupported transports or actions; read-only current openclerk document and retrieval JSON only","authority_limits":"canonical markdown remains authority; graph and records projections are derived evidence with citations, provenance, and freshness; this eval-only response does not implement a relationship-record lookup action"}.`,
		...
		},
		{
			...
			Prompt: "Use the configured local OpenClerk data path. Run the promoted source_audit_report retrieval action to repair the existing source-sensitive audit synthesis and explain the conflicting source evidence. Do not use create_document, direct vault edits, SQLite, rg, find, ls, broad repo search, source-built runners, HTTP/MCP, backend variants, or a broad contradiction-engine claim. The target is synthesis/audit-runner-routing.md; the query is source-sensitive audit runner repair evidence; the conflict query is source sensitive audit conflict runner retention; use repair_existing mode with a reasonable non-negative limit. The final answer must mention source_audit_report, synthesis/audit-runner-routing.md, sources/audit-runner-current.md, sources/audit-conflict-alpha.md, sources/audit-conflict-bravo.md, provenance, projection freshness, duplicate prevention, repair_existing, unresolved seven-day vs thirty-day conflict, validation boundaries, authority limits, and that no broad contradiction engine is claimed. State that the narrow source_audit_report plus existing primitives is selected while broad contradiction-engine work remains rejected/deferred. Use repo-relative paths only.",
		},
		{
			ID:     evidenceBundleWorkflowActionScenarioID,
			Title:  "Evidence bundle workflow action natural intent",
			Prompt: "Use the configured local OpenClerk data path. Produce a read-only evidence bundle for the AgentOps Escalation Policy decision/record evidence using the promoted evidence_bundle_report retrieval action. Do not create or update documents and do not use direct vault edits, SQLite, rg, find, ls, broad repo search, source-built runners, HTTP/MCP, backend variants, memory transport, vector DB, or hidden authority ranking. Use the entity_id agentops-escalation-policy, the query AgentOps Escalation Policy, projection records, and a reasonable non-negative limit. In the final answer, mention evidence_bundle_report, records/policies/agentops-escalation-policy.md, citations, provenance, records projection freshness, validation boundaries, authority limits, and read-only behavior. Use repo-relative paths only.",
		},
		{
...
Do not create, append, replace, or file a synthesis document. In the final answer, mention synthesis/native-media-transcript-acquisition.md, sources/native-media/vendor-webinar-current.md, same-transcript no-op, changed-transcript update, stale freshness/projection evidence, provenance, and that no native media acquisition dependency was used.`,
		...
		},
		{
			...
			Prompt: "Use the configured local OpenClerk data path. Refresh the existing compile_synthesis revisit synthesis with the promoted compile_synthesis document action, not lower-level create_document, replace_section, append_document, direct vault edits, source-built runners, SQLite, HTTP/MCP, rg, find, ls, broad repo search, or raw vault inspection. Keep the target synthesis/compile-revisit-routing.md rather than the decoy, preserve a single-line source_refs value for sources/compile-revisit-current.md and sources/compile-revisit-old.md, include ## Sources and ## Freshness, and include these body facts: Current compile_synthesis revisit decision: promoted compile_synthesis handles the routine workflow while primitives remain for manual cases; Current source: sources/compile-revisit-current.md; Superseded source: sources/compile-revisit-old.md. In the final answer, mention compile_synthesis, the selected path, source evidence, duplicate status, provenance refs, projection freshness, write status, validation boundaries, and authority limits. Use repo-relative paths only.",
		},
		{
